                        ...
                        <div class="row coffeeholic-section">
                            <div class="col-none-12 col-md-6 col-lg-4">
                                <div class="story-box">
                                    ...
                                    <div class="article-title">
                                        <a href="#" class=""
                                            >Joie - Góc sân và khoảng trời
                                        </a>
                                    </div>
                                    <p class="article-content">
                                        Một trải nghiệm chiều mưa, với cốc trà
                                        vải và những khoảng lặng trong cuộc sống
                                        này
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-none-12 col-md-6 col-lg-4">
                                <div class="story-box">
                                    ...
                                    <p class="article-content">
                                        Lý do chúng ta nên dành một buổi chiều
                                        để đến đây và thưởng thức những sản phẩm
                                        của Joie
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="col-none-12 col-md-6 col-lg-4">
                                <div class="story-box">
                                    ...
                                    <div class="article-title">
                                        <a href="#" class=""
                                            >Joie - Góc sân và khoảng trời: Có
                                            xứng đáng với tên gọi
                                        </a>
                                    </div>
                                    <p class="article-content">
                                        Liệu có sứng đáng với cái tên trùng với
                                        kiệt tác Góc sân và khoảng trời của Trần
                                        Đăng Khoa xuất bản năm 1968?
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row coffeeholic-section">
                                <div class="col-none-12 col-md-6 col-lg-4">
                                    <div class="story-box">
                                        ...
                                        <div class="article-title">
                                            <a href="#" class=""
                                                >Từ khi nào mà chúng ta lại lệ
                                                thuộc vào caffee
                                            </a>
                                        </div>
                                        <p class="article-content">
                                            Để bắt đầu một buổi sáng đầy năng
                                            lượng, chúng ta đều bắt đầu bằng một
                                            tách caffe. Nhưng điều đó có đúng
                                            khi chúng ta quá lạm dụng nó?
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="col-none-12 col-md-6 col-lg-4">
                                    <div class="story-box">
                                        ...
                                        <div class="article-title">
                                            <a href="#" class=""
                                                >Một chiều chủ nhật mưa xuân
                                            </a>
                                        </div>
                                        <p class="article-content">
                                            Tôi luôn tự hỏi, vì sao tôi lại yêu
                                            thích sự yên tĩnh. Có phải vì tôi
                                            trầm tính, hay chỉ đang tìm kiếm
                                            những khoảng lặng trong cuộc đời
                                            sinh viên đầy sô bồ của tôi?
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="col-none-12 col-md-6 col-lg-4">
                                    <div class="story-box">
                                        ...
                                        <div class="article-title">
                                            <a href="#" class=""
                                                >Mối quan hệ đều dựa trên tách
                                                caffee?
                                            </a>
                                        </div>
                                        <p class="article-content">
                                            Khi nhỏ chúng ta đi công viên, cánh
                                            đồng để làm bạn. Cấp 2, 3 chúng ta
                                            làm bạn với những bạn cùng lớp. Lên
                                            đại học, chúng ta dùng tách caffee
                                            để ngỏ lời. Vậy điều đó có đúng?
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row coffeeholic-section">
                                <div class="col-none-12 col-md-6 col-lg-4">
                                    <div class="story-box">
                                        ...
                                        <div class="article-title">
                                            <a href="#" class=""
                                                >Một giáo viên đã truyền cảm
                                                hứng cho chúng tôi tạo ra trang
                                                web này.
                                            </a>
                                        </div>
                                        <p class="article-content">
                                            Chúng tôi tạo ra trang web này với
                                            tình yêu dành cho cùng một loại cà
                                            phê. Chúng tôi hy vọng trang web này
                                            sẽ được những người yêu thích cà phê
                                ...
                                <div class="col-none-12 col-md-6 col-lg-4">
                                    <div class="story-box">
                                        ...
                                        <p class="article-content">
                                            Là một giáo viên bộ môm Hệ thống
                                            thông tin tại SOICT, với niềm đam mê
                                            cà phê bất diệt, chúng tôi hi vọng
                                            thầy chính là hình mãu tương lai của
                                            chúng tôi: người đồng nghiệp kính
                                            mến và người thầy mẫu mực
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="col-none-12 col-md-6 col-lg-4">
                                    <div class="story-box">
                                        ...
                                        <div class="article-title">
                                            <a href="#" class=""
                                                >Caffe: Có đơn thuần chỉ là một
                                                loại đồ uống
                                            </a>
                                        </div>
                                        <p class="article-content">
                                            Tôi luôn tự hỏi bản thân: "Mình đi
                                            caffe để làm gì? Có đơn thuần chỉ là
                                            một nơi để thưởng thức tách caffe?".
                                            Bạn tôi đã nói: "Caffe không hề đơn
                                            thuần là caffe, nó là linh hồn, là
                                            bản thân , là mối quan hệ xung
                                            quanh". Đến bây giờ, tôi cũng hiểu
                                            điều đó.
                                        </p>
                                    </div>
                                </div>
